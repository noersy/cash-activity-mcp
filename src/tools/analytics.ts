...
export function registerAnalyticsTools(server: McpServer, client: CashActivityClient): void {
  server.tool(
    "get_category_breakdown",
    "Get spending/income breakdown by category for a date range",
    {
  ...
  server.tool(
    "bulk_categorize",
    "Auto-categorize multiple transactions using AI",
    {
